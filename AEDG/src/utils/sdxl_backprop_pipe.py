...
from .cross_attention import prepare_unet, free_unet, get_and_release_last_attention, \
    get_initial_cross_attention_all_timesteps, p2p_reshape_initial_cross_attention, get_attention_interpolation_factor
...
class StableDiffusionXLPipelineWithGrad(StableDiffusionXLPipeline):
    ...
    def __init__(
        ...
        super().__init__(vae=vae, text_encoder=text_encoder, text_encoder_2=text_encoder_2, tokenizer=tokenizer,
                         tokenizer_2=tokenizer_2, unet=unet,
    ...
    def __call__(
        ...
        initial_latents_norm = torch.norm(latents.view(-1), p=2)
        ...
        #setup optimizer
        optim = self.create_optimizer(latents, uncond_embeds_delta, conditional_embeds_delta, optimize_latents,
