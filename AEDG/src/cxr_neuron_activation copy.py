...
if __name__=="__main__":
    ...
    classifier = load_tv('doesnt_matter')
...
#     ])
    ...
    loss_function = get_loss_function('conf', classifier)
    ...
    # for i in [0]:
        ...
        for img_idx in range(args.num_images):
            ...
            confs = calculate_confs(classifier, img_grid, device, target_class=None, return_predictions=False)
            ...
            plot(None, None, img_grid, caption, confs, os.path.join(result_folder, f'{img_idx}.pdf'),attribute_values_over_trajectory_2=confs,preds=target_preds, preds_maha=confs,confs=confs,t1_maha=None, t2_maha=None, t1_msp=None, t2_msp=None, loss_scores=losses)
